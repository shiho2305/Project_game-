...
function OnExecute(ability)
	...
	if (hit and hit.other and hit.other:IsA("StaticMesh")) then
		...
		if ((script.parent:GetCustomProperty("OnlyTeam90") and hit.other.team ~= 90) or (hit.other:GetColor() == Color.BLACK or (ability.owner.team ~= hit.other.team and hit.other.team ~= 0 and hit.other.team ~= 90))) then
