...
local IDLE_STANCE = script:GetCustomProperty("IdleStance") or "1hand_unarmed_idle_ready"
local READY_STANCE = script:GetCustomProperty("ReadyStance") or "1hand_unarmed_idle_ready"
local WALK_STANCE = script:GetCustomProperty("WalkStance") or "1hand_melee_walk_forward"
local RUN_STANCE = script:GetCustomProperty("RunStance") or "1hand_unarmed_run_forward"
