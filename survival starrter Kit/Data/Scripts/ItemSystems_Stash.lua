...
function Stash:SetupDeathDropStash(player) -- Player player
    ...
    -- There's a chance the player may leave when this occurs.
    -- If this happens then don't drop their items.
    -- If they log out outside a safe zone then they'll still lose their stuff.
    Task.Wait(0.1)
