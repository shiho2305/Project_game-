...
---------------------------------------------------------------------------------------------------------
function StatSheet:AddHunger(hunger)
...
function StatSheet:SetHunger(hunger)
    self.hunger = hunger
    if self.hunger >= 100 then
        self.hunger = 100
    elseif self.hunger <= 0 then
...
function StatSheet:GetHunger()
    return self.hunger
end

function StatSheet:AddThirst(thirst)
    self.thirst = self.thirst + thirst
...
function StatSheet:SetThirst(thirst)
    self.thirst = thirst
    if self.thirst >= 100 then
        self.thirst = 100
    elseif self.thirst <= 0 then
...
function StatSheet:_Init()
    ...
    self.staminaRegenerationRate = 5
